...
ICONS = {
    ...
    "icon_neural_overload": ("brainstorm", "Lorc"),
    ...
    "icon_powerplant": ("power-lightning", "Lorc"),
    # status effects (E018+) - shown in the HUD status row
    "icon_radiance": ("beams-aura", "Lorc"),
    "icon_fear": ("terror", "Lorc"),
    "icon_luminosity": ("star-pupil", "Lorc"),
    "icon_harmony": ("yin-yang", "Delapouite"),
    "icon_concussion": ("brain", "Lorc"),
    "icon_absolute_radiance": ("explosion-rays", "Lorc"),
}
