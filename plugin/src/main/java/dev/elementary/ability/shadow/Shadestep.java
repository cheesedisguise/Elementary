...
/** Shadestep: vanish and reappear along your look direction - or,
 *  aimed at prey, directly at their back, knife-ready. (Standing in
 *  for the still-unwritten Vanquish.) */
public class Shadestep implements Ability {
    private final JavaPlugin plugin;

    public Shadestep(JavaPlugin plugin) { this.plugin = plugin; }

    @Override public String name() { return "Shadestep"; }
